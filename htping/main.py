...
def signal_handler(sig, frame):
    ...
    print(f"{transmitted} packets transmitted, {received} received, {packet_loss:.0f}% packet loss")
...
def main():
    ...
    parser.add_argument('-i', '--interval', type=float, default=1.0, help='Interval in seconds between requests')
    parser.add_argument('-c', '--count', type=int, default=None, help='Number of pings to send')
